...
include_recipe 'nginx-pixelcog::ohai_plugin'

if platform_family?('rhel')
  if node['nginx']['repo_source'] == 'epel'
    include_recipe 'yum-epel'
  elsif node['nginx']['repo_source'] == 'nginx'
    include_recipe 'nginx-pixelcog::repo'
  ...
  include_recipe 'nginx-pixelcog::repo' if node['nginx']['repo_source'] == 'nginx'
end
...
include_recipe 'nginx-pixelcog::commons'
